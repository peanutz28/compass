...
export function ProtectionSummary() {
  ...
  return (
    <div className="rounded-2xl bg-card p-7 shadow-[0_2px_16px_rgba(0,0,0,0.06)]">
      ...
      <p className="mt-1 text-sm text-muted-foreground">Rules set by you · Always enforced</p>

      <div className="mt-6 space-y-4">
        <div className="flex items-center justify-between">
          <span className="text-sm text-muted-foreground">Daily Limit</span>
          <div className="flex items-center gap-2">
            <span className="text-sm font-medium text-foreground">$150/day</span>
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="text-sm font-medium text-accent hover:underline">12 payees</button>
        </div>

        <div className="flex items-center justify-between">
          <span className="text-sm text-muted-foreground">Blocked Phrases</span>
          <button className="text-sm font-medium text-accent hover:underline">8 phrases</button>
        </div>

        <div className="flex items-center justify-between">
          <span className="text-sm text-muted-foreground">Approval Threshold</span>
          <div className="flex items-center gap-2">
            <span className="text-sm font-medium text-foreground">Over $100</span>
            <button className="text-muted-foreground hover:text-foreground">
              <Pencil className="h-3.5 w-3.5" />
            </button>
          </div>
