...
export function BlockedScamModal({ isOpen, onClose }: BlockedScamModalProps) {
    ...
    >
      ...
      >
        ...
        <div className="px-10 pb-8 pt-12">
          ...
          {/* Three red reason chips */}
          <div className="mt-6 flex flex-wrap justify-center gap-2">
            <span className="inline-flex items-center rounded-full bg-[#E07A5F]/15 px-4 py-2 text-sm font-medium text-[#C4503E]">
